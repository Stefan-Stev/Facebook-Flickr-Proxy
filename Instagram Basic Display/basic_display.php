		...
		Class instagram_basic_display_api{
			...
			private function _setUserInstagramAccessToken($params){
				...
				if($params['get_code']){ //daca am codul
					...
					//Acum obtinem long-lived access token-ul
			...
			private function _getLongLivedUserAccessToken(){
				$params= array(
					'endpoint_url'=>$this->_graphBaseUrl . 'access_token', //endpoint-ul este efectiv adresa la care vrei sa faci request-ul(API call-ul)
					'type'=>'GET', //requestul http e de tip POST, sincer nu am inteles de ce nu e GET
					'url_params'=>array( //array-ul de parametri la care o sa se uite Instagram cand ii facem api call-ul, note: este un array intr-un array
			...
			public function getUser(){
				$params= array(
					'endpoint_url'=>$this->_graphBaseUrl . 'me', //endpoint-ul este efectiv adresa la care vrei sa faci request-ul(API call-ul)
					'type'=>'GET', //requestul http e de tip POST, sincer nu am inteles de ce nu e GET
					'url_params'=>array( //array-ul de parametri la care o sa se uite Instagram cand ii facem api call-ul, note: este un array intr-un array
			...
			public function getUsersPosts(){
				$params= array(
					'endpoint_url'=>$this->_graphBaseUrl.'me'.'/media', //endpoint-ul este efectiv adresa la care vrei sa faci request-ul(API call-ul)
					'type'=>'GET', //requestul http e de tip POST, sincer nu am inteles de ce nu e GET
					'url_params'=>array( //array-ul de parametri la care o sa se uite Instagram cand ii facem api call-ul, note: este un array intr-un array
