<?php
  ...
  $response = $fb->post(
    '/112510383726603/feed',   //numarul acela este id paginii
    array (
      "message" => "Social Media Platform"
    ),'EAAQM6NoB0t0BABnukB3CrOFpxLyPra6r6QoHuKbbMnETb1egnrZCi8w7X7Ubk4ZCbUX0BxZA451Fjbk5LY4LNiTgZBtLyc5qTZBeZBKUaI8LvcfbwSyYQtBkayhIlNknuveOsfCiWdlpucDzBksbA8wb1sfEHaEeykn7FMfM7JLwuAi0guZAdbE') //atentie! nu este acces token al utilizatorului , ci cel al paginii . Btw, este unul valid timp de 2 luni, nu numai o ora ...
      ;
...
$graphNode = $response->getGraphNode();		// display everything in the browser
		...
		$loginUrl = $helper->getLoginUrl( 'https://web-rfnl5hmkocvsi.azurewebsites.net/fbTest/indexPost.php', $permissions );
